            ...
            <div class="widget mercado-widget categories-widget">
                ...
                <ul class="list-cate">
                    @foreach ($categorias as $categoria)
                        <li class="category-item"><a href="#" class="cate-link"> {{ $categoria->nombre_categoria }}</a></li>
                ...
                <div class="widget-content">
                    <ul class="list-style vertical-list list-limited" data-show="6">
                        @foreach ($productos as $producto)
                            <li class="category-item"><a href="#" class="cate-link"> {{ $producto->nombre_producto }}</a></li>       
                        @endforeach
            ...
            <div class="widget mercado-widget filter-widget">
                ...
                <div class="widget-content">
                    <ul class="list-style vertical-list has-count-index">
                        ...
                        @foreach ($productos as $producto)
                            <li class="category-item"><a href="#" class="cate-link"> {{ $producto->color }}</a></li>       
                        @endforeach
                    </ul>
                </div>
            </div><!-- Color -->
            ...
            <div class="widget mercado-widget filter-widget">
                ...
                <div class="widget-content">
                    <ul class="list-style inline-round ">
                        ...
                        @foreach ($productos as $producto)
                            <li class="list-item"><a href="#" class="filter-link"> {{ $producto->tamano }}</a></li>       
                        @endforeach
                    </ul>
